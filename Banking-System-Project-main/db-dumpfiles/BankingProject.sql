...
To get the Admin Portal :- localhost:8085/admin/index

To get the Employee Portal :-localhost:8085/employee/index

To get the Customer Portal :-localhost:8085/customer/index
